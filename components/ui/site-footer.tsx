...
const SiteFooter: React.FC = () => {
  ...
  return (
    <footer className="border-t border-slate-800 bg-[#0b1524] text-slate-300">
      <div className="mx-auto max-w-6xl px-6 py-16">
        <div className="grid gap-12 lg:grid-cols-4">
          <div className="space-y-4">
            <Link to="/home" className="inline-flex flex-col gap-1 text-left">
              <span className="text-sm font-semibold tracking-[0.32em] text-slate-400">
                VOFMUN
              </span>
        ...
        <div className="mt-12 border-t border-slate-800 pt-6 text-sm text-slate-500 sm:flex sm:items-center sm:justify-between">
          ...
          <div className="mt-3 flex items-center gap-2 sm:mt-0">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="font-medium text-slate-300 transition-colors hover:text-white hover:underline"
            >
              Ansh Gupta
            </a>
          </div>
