...
const Page = () => {
  ...
  return (
    <ProtectedRoute>
      <VOFMUNPageShell>
        <div className="page-maxwidth space-y-8 px-4 pb-8 pt-8 md:px-6 lg:px-8">
          <motion.section initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
            <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
              <VOFMUNCard className="relative overflow-hidden lg:col-span-2">
                ...
                <div className="relative z-10 flex min-h-[320px] flex-col justify-end p-7 text-white md:p-10">
                  <VOFMUNBadge className="mb-4 w-fit bg-white/15 text-[#FFF0E5]">General Assembly Session IV</VOFMUNBadge>
                  <h1 className="mb-3 text-4xl italic leading-tight md:text-5xl" style={{ fontFamily: "var(--font-newsreader, 'Newsreader', serif)" }}>
          ...
          <motion.section initial={{ opacity: 0, y: 22 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.08 }}>
            <div className="grid grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-4">
              <VOFMUNCard className="bg-[#FFF0E5] p-6 md:col-span-2">
