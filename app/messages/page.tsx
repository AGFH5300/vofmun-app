    ...
    <div className="min-h-screen bg-gradient-to-br from-soft-ivory to-warm-light-grey/60">
      <div className="mx-auto max-w-6xl px-4 py-8">
        <header className="mb-4 flex flex-col gap-2">
          <p className="text-[0.7rem] uppercase tracking-[0.3em] text-deep-red/80">
            Real-time coordination
          </p>
          <div className="flex items-center gap-3">
            <h1 className="text-3xl font-heading font-semibold text-deep-red">
              Messages
            </h1>
            {isConnecting && (
          ...
          <p className="text-sm text-almost-black-green/80">
            Coordinate with delegates, chairs, and secretariat. Presence,
            typing, and unread updates keep you in the loop.
          </p>
        </header>
            ...
            <section className="flex h-[720px] flex-col bg-gradient-to-b from-white to-warm-light-grey/40">
              <header className="flex items-center justify-between border-b border-soft-ivory px-6 py-4">
                ...
                {activeRoom ? (
                  ...
                  <div className="text-sm text-almost-black-green/60">
                    ...
                    activeMessages.length > 0 ? (
                      ...
                      <div className="flex h-full items-center justify-center text-center text-almost-black-green/60">
                        <div className="space-y-2">
                          <Users
                            className="mx-auto text-deep-red/40"
                            size={44}
                          />
